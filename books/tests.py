...
class BookModelTest(TestCase):
    ...
    # Test if book name is initialized as expected
    ...
    # Test that author name is a max of 120 characters
    ...
    # Test that absolute URL is correctly generated and that the BookDetailView loads when title is clicked
